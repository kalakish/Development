...
class SQLServerAgent {
    ...
    async attachSchedule(jobId, scheduleName) {
        await this.connection.query(`
            USE msdb;
    ...
    async detachSchedule(jobId, scheduleName) {
        await this.connection.query(`
            USE msdb;
    ...
    createScheduleScript(jobId, schedule) {
        return `
            EXEC dbo.sp_add_schedule
    ...
    parseJobStatus(row) {
        if (!row)
            return { running: false, enabled: false, lastRun: null };
...
exports.SQLServerAgent = SQLServerAgent;
//# sourceMappingURL=sqlserver-agent.js.map