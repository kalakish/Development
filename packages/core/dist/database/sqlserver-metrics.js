...
exports.SQLServerMetrics = void 0;
class SQLServerMetrics {
    // Connection metrics
    ...
    maxAcquireTime = 0;
    minAcquireTime = Number.MAX_SAFE_INTEGER;
    totalIdleTime = 0;
    averageIdleTime = 0;
    // Throughput metrics
    rowsAffected = 0;
    ...
    recordQuery(type, duration, rows = 0, bytes = 0) {
        this.totalQueries++;
    ...
    recordConnectionAcquire(duration, hit = false) {
    ...
    recordConnectionRelease(idleTime) {
    ...
    clone() {
        return new SQLServerMetrics(this.toJSON());
    }
    merge(other) {
...
exports.SQLServerMetrics = SQLServerMetrics;
//# sourceMappingURL=sqlserver-metrics.js.map