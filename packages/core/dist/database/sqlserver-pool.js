...
exports.SQLServerPool = exports.SQLServerPoolManager = void 0;
const mssql_1 = require("mssql");
const events_1 = require("events");
const sqlserver_metrics_1 = require("./sqlserver-metrics");
class SQLServerPoolManager extends events_1.EventEmitter {
    pools = new Map();
    poolConfigs = new Map();
    poolMetrics = new Map();
    poolStats = new Map();
    ...
    async createPool(name, config, poolConfig) {
        ...
        this.poolConfigs.set(name, finalPoolConfig);
    ...
    async recreatePool(name, config) {
    ...
    initializeMetrics(name) {
        this.poolMetrics.set(name, new sqlserver_metrics_1.SQLServerMetrics());
    }
    ...
    // ============ Utility Methods ============
    async executeOnPool(name, callback) {
...
exports.SQLServerPoolManager = SQLServerPoolManager;
class SQLServerPool {
    static instance;
    static getInstance() {
...
exports.SQLServerPool = SQLServerPool;
//# sourceMappingURL=sqlserver-pool.js.map