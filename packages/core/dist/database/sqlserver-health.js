...
exports.SQLServerHealth = void 0;
class SQLServerHealth {
    poolManager;
    thresholds;
    constructor(poolManager, thresholds) {
    ...
    async checkConnectivity(name, checks) {
        const startTime = Date.now();
        try {
    ...
    async checkSystemHealth(checks) {
        const startTime = Date.now();
        try {
            // Get system metrics
    ...
    async checkConnectivity(poolName) {
        const startTime = Date.now();
        try {
    ...
    // ============ Health Report ============
    async generateHealthReport(poolName) {
...
exports.SQLServerHealth = SQLServerHealth;
//# sourceMappingURL=sqlserver-health.js.map